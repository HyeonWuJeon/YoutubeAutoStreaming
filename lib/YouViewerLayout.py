...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(881, 810))
        MainWindow.setMaximumSize(QtCore.QSize(881, 795))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("H:/workspace/my_project/AutoYoutube/resource/title_ico.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label.setGeometry(QtCore.QRect(5, 20, 180, 111))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("H:/workspace/my_project/AutoYoutube/resource/irene.png"))
        ...
        self.webView.setUrl(QtCore.QUrl("about:blank")) #비활성
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Streaming youtube"))
        self.groupBox.setTitle(_translate("MainWindow", "irene"))
        ...
        self.label_5.setText(_translate("MainWindow", "saveTo:"))
        ...
        self.label_2.setText(_translate("MainWindow", "브라우저"))
